...
function HomePageSectionThree() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#202020", fontFamily: "Albert Sans, sans-serif" }}
    >
      <div className="h-[800px] w-[1280px] flex flex-col justify-between">
      {/* Top Logo Belt */}
      ...
      <div className="flex justify-center pb-10">
        <LearnMoreButton text="Learn More" element={<GoArrowRight size={24} />} />
      </div>
      </div>
    </div>
  );
